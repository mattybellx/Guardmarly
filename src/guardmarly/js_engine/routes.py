...
from guardmarly.js_engine.common import COMMENT_LINE_RE, strip_comments, consume_balanced
...
from guardmarly.js_engine.structure import collect_calls, parse_object_literal, split_top_level_args
from guardmarly.js_engine.taint import append_trace, extract_taint_traces, merge_traces, trace_for_expr
