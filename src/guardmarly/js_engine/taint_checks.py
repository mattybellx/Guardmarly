...
from guardmarly.js_engine.common import COMMENT_LINE_RE
...
from guardmarly.js_engine.taint import append_trace, extract_taint_traces, merge_traces, trace_for_expr, trace_has_sanitizer
