...
from guardmarly.js_engine.common import COMMENT_LINE_RE, strip_js_comments_preserve_layout
...
def run_pattern_rules(code: str, *, agent: str = "js-analyzer") -> list[Finding]:
    ...
    if simple_rules:
        try:
            from guardmarly_rust_core import fast_pattern_rules as _rust_fast
