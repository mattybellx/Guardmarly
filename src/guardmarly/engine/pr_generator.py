"""guardmarly.engine.pr_generator
──────────────────────────────────────────────────────────────────────────────
...
Usage (via CLI):
  guardmarly src/ --pr                     # Write PR doc to stdout
  guardmarly src/ --pr --pr-output pr.md   # Write PR doc to file
"""
...
def generate_pr_body(
    ...
    *,
    ...
    author: str = "guardmarly bot",
    branch: str = "auto-fix/guardmarly-remediation",
) -> str:
    ...
    lines.append("")
    lines.append(
        "This PR was automatically generated by **guardmarly** after detecting "
    ...
    lines.append("")
    lines.append(
        "_Generated by [guardmarly](https://github.com/mattybellx/Guardmarly) — "
...
with respect to the current guardmarly rule set.

_Generated by guardmarly_
"""
