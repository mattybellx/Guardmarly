...
_LLM_MEMORY_PATH = Path.home() / ".guardmarly" / "llm_memory.json"
...
_FEW_SHOT_SIDECAR_PATH = Path.home() / ".guardmarly" / "few_shot_examples.jsonl"  # Curated 354-example sidecar (Track 3)
