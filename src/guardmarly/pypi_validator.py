"""guardmarly.pypi_validator
──────────────────────────────────────────────────────────────────────────────
PyPI Readiness Validator for Guardmarly.
...
Run: python -m guardmarly.pypi_validator
"""
...
class PyPIValidator:
    ...
    def validate_all(self) -> PyPIValidationResult:
        ...
        print("🔍 Validating PyPI readiness for guardmarly...\n")
    ...
    def _check_imports(self) -> bool:
        ...
        try:
            ...
            modules = [
                ...
                "guardmarly.hardening",
                "guardmarly.engine.triage",
                "guardmarly.engine.remediation",
            ]
            ...
            self.result.errors.append(f"❌ Cannot import guardmarly: {e}")
            return False
