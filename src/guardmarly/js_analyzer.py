...
from guardmarly.js_engine.taint import extract_taint_traces, trace_for_expr, trace_has_sanitizer
    ...
    *,
    ...
    for runner, label in (
        ...
        try:
            ...
            _log.warning("guardmarly: JS %s failed on %r: %s — results may be incomplete", label, filename, exc)
